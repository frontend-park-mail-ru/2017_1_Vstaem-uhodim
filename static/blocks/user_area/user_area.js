  ...
  class UserArea {
    ...
    setContent() {
      ...
      if (this.type == "authorized") {
        ...
        this.el.querySelector("#js-index-logout").addEventListener("click", function() {
      ...
      if (this.type == "notAuthorized") {
        ...
        this.el.querySelector("#js-index-signup").addEventListener("click", function() {
          user_area.dispatchEvent(new Event("signup"));
        });

        this.el.querySelector("#js-index-login").addEventListener("click", function() {
